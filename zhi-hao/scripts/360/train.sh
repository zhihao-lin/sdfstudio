...
ns-train bakedsdf-mlp --vis wandb \
    ...
    --pipeline.model.eikonal-loss-mult 0.01 --pipeline.model.num-neus-samples-per-ray 24 \
    --machine.num-gpus 1 --pipeline.model.scene-contraction-norm l2\
    mipnerf360-data --data data/colmap_sdfstudio/bicycle \
    --center-poses False --orientation-method none --auto-scale-poses False
...
ns-train bakedsdf-mlp --vis wandb \
    ...
    --pipeline.model.eikonal-loss-mult 0.01 --pipeline.model.num-neus-samples-per-ray 24 \
    --machine.num-gpus 1 \
    mipnerf360-data --data data/colmap_sdfstudio/bonsai \
    --center-poses False --orientation-method none --auto-scale-poses False
...
ns-train bakedsdf-mlp --vis wandb \
    ...
    --pipeline.model.eikonal-loss-mult 0.01 --pipeline.model.num-neus-samples-per-ray 24 \
    --machine.num-gpus 1 \
    mipnerf360-data --data data/colmap_sdfstudio/kitchen \
    --center-poses False --orientation-method none --auto-scale-poses False
...
ns-train bakedsdf-mlp --vis wandb \
    ...
    --pipeline.model.eikonal-loss-mult 0.01 --pipeline.model.num-neus-samples-per-ray 24 \
    --machine.num-gpus 1 \
    mipnerf360-data --data data/colmap_sdfstudio/room \
    --center-poses False --orientation-method none --auto-scale-poses False
